...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function sample(d) {
    ...
    if (d.id === "TPL-02-01") {
      return '<div class="cv-sample-window"><div class="cv-real cv-corp-trad"><div class="ct-top"><div><div class="ct-kicker">PERFIL PROFESIONAL</div><div class="ct-name">NOMBRE APELLIDO</div><div class="ct-role">DIRECTOR · GERENCIA · OPERACIONES</div></div><div class="ct-contact">+000 0000 0000<br>correo@ejemplo.com<br>Managua, Nicaragua</div></div><div class="ct-ribbon">EXPERIENCIA · FORMACIÓN · COMPETENCIAS</div><main class="ct-main">' + exp + edu + profile + '</main></div></div>';
    }
    if (d.id === "TPL-02-02") {
      return '<div class="cv-sample-window"><div class="cv-real cv-corp-moderno"><header><div class="cm-photo">FOTO</div><div><div class="cm-kicker">PROFESSIONAL PROFILE</div><div class="cm-name">NOMBRE APELLIDO</div><div class="cm-role">GESTIÓN · ESTRATEGIA · RESULTADOS</div></div></header><div class="cm-modules"><section class="cm-feature">' + profile + '</section><section>' + exp + '</section><aside>' + skills + contact + '</aside><section>' + edu + '</section></div></div></div>';
    }
    if (d.id === "TPL-02-03") {
      return '<div class="cv-sample-window"><div class="cv-real cv-corp-ats"><header><div class="ca-kicker">CURRÍCULUM PROFESIONAL · ATS</div><div class="ca-name">NOMBRE APELLIDO</div><div class="ca-role">ESPECIALISTA PROFESIONAL</div><p>Managua, Nicaragua · +000 0000 0000 · correo@ejemplo.com · LinkedIn</p></header><main class="ca-main">' + profile + exp + edu + skills + langs + '</main></div></div>';
    }
    if (d.id === "TPL-02-04") {
      return '<div class="cv-sample-window"><div class="cv-real cv-corp-compact"><header><div class="cc-index">01</div><div><div class="cc-name">NOMBRE APELLIDO</div><div class="cc-role">PROFESIONAL · ESPECIALIDAD</div></div><div class="cc-photo">FOTO</div></header><div class="cc-bento"><section class="cc-large">' + exp + '</section><section>' + profile + '</section><section>' + skills + '</section><section>' + edu + '</section><section class="cc-contact">' + contact + '</section></div></div></div>';
    }
    if (d.id === "TPL-02-05") {
      return '<div class="cv-sample-window"><div class="cv-real cv-corp-international"><header><div><div class="ci-kicker">GLOBAL PROFESSIONAL</div><div class="ci-name">NOMBRE APELLIDO</div><div class="ci-role">INTERNATIONAL BUSINESS · STRATEGY</div></div>' + photo + '</header><div class="ci-languages"><span>ES · NATIVO</span><span>EN · AVANZADO</span><span>GLOBAL PROFILE</span></div><div class="ci-content"><main>' + profile + exp + edu + '</main><aside>' + langs + skills + '</aside></div><footer>CONTACT · AVAILABILITY · INTERNATIONAL EXPERIENCE</footer></div></div>';
    }
    if (d.id === "TPL-03-01") {
      return '<div class="cv-sample-window"><div class="cv-real cv-academic-trad"><header><div class="at-label">CURRICULUM ACADÉMICO</div><div class="at-name">NOMBRE APELLIDO</div><div class="at-role">DOCENTE · INVESTIGADOR · AUTOR</div><p>Universidad / Institución · Ciudad, País · correo@ejemplo.com</p></header><div class="at-credentials"><span>FORMACIÓN</span><span>INVESTIGACIÓN</span><span>PUBLICACIONES</span><span>DOCENCIA</span></div><main>' + edu + exp + profile + '<div class="at-publications"><h5>PUBLICACIONES Y CONGRESOS</h5><p>Artículos, ponencias, proyectos y producción académica.</p></div></main></div></div>';
    }
    if (d.id === "TPL-03-02") {
      return '<div class="cv-sample-window"><div class="cv-real cv-academic-research"><header><div class="ar-code">RESEARCH<br>CV</div><div><div class="ar-name">NOMBRE APELLIDO</div><div class="ar-role">INVESTIGADOR · CIENCIA · DESARROLLO</div><div class="ar-line">Educación · Investigación · Proyectos</div></div></header><div class="ar-research-body"><main><div class="ar-timeline"><div><span>2024</span><strong>Proyecto de investigación</strong><p>Descripción breve del proyecto y resultados.</p></div><div><span>2021</span><strong>Investigador / Universidad</strong><p>Experiencia académica y científica.</p></div><div><span>2018</span><strong>Formación especializada</strong><p>Doctorado · Maestría · Especialidad.</p></div></div>' + exp + '</main><aside>' + langs + skills + '<div class="ar-pubs">PUBLICACIONES<br><b>Artículos · Congresos</b></div></aside></div></div></div>';
    }
    var layouts = {
